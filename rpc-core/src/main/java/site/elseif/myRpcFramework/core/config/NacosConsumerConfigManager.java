...
@Slf4j
public class NacosConsumerConfigManager extends NacosConfigManager {

    public NacosConsumerConfigManager(String serverAddr, String dataId, String group, ServiceConfigManager serviceConfigManager) {
        super(serverAddr, dataId, group, serviceConfigManager);
    }

    @Override
    protected void GetAndParseConfig(String yamlConfig) {
        try {
            Yaml yaml = new Yaml();
            ...
            for (Map<String, Object> serviceConfig : services) {
                ...
                Map<String, Object> consumerConfig = (Map<String, Object>) serviceConfig.get("consumer");

                // 解析方法配置
                List<Map<String, Object>> methods = (List<Map<String, Object>>) consumerConfig.get("methods");
                if (methods != null) {
